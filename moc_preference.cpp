/****************************************************************************
** Meta object code from reading C++ file 'preference.hpp'
**
...
#include <memory>
#include "src/preference.hpp"
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'preference.hpp' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Preference_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Preference_t qt_meta_stringdata_Preference = {
    {
        QT_MOC_LITERAL(0, 10),  // "Preference"
        QT_MOC_LITERAL(11, 18),  // "sliderValueChanged"
        QT_MOC_LITERAL(30, 0),  // ""
...
Q_CONSTINIT static const uint qt_meta_data_Preference[] = {
...
Q_CONSTINIT const QMetaObject Preference::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_Preference.offsetsAndSizes,
...
void Preference::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Preference::*)(int );
            if (_t _q_method = &Preference::sliderValueChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Preference::sliderValueChanged(int _t1)
{
